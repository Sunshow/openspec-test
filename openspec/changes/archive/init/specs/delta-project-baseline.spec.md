# Delta Specs: OpenSpec Initialization

## ADDED: SPEC-001 — OpenSpec Directory Structure
...
## ADDED: SPEC-003 — Spec Format Convention
...
## ADDED: SPEC-004 — Change Workflow
...
## ADDED: SPEC-005 — Archive Workflow
